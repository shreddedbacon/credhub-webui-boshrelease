...
```
## UAA Client
You will need to apply ops similar to this to your UAA to allow CredHub WebUI to use OAuth
```
...
- type: replace
  ...
  value:
    ...
    autoapprove: true
    override: true
    redirect-uri: https://localhost:8443/login/callback #should match the url that will run your credhub-webui
    show-on-homepage: true
    app-launch-url: https://localhost:8443 #should match the url that will run your credhub-webui
